            ...
            <ul>
                ...
                <c:if test="${pagination.pageCount >5 }">
                	...
                	<c:if test="${pagination.pageNo-2>1 && pagination.pageNo+2<pagination.pageCount}">
                		...
                		<li><a href="javascript:go(${pagination.pageNo })">${pagination.pageNo }</a></li>
                		<li><a href="javascript:go(${pagination.pageNo+1 })">${pagination.pageNo+1 }</a></li>
                		<li><a href="javascript:go(${pagination.pageNo+2 })">${pagination.pageNo+2 }</a></li>
                		<li>...</li>
                	</c:if>
                	<c:if test="${pagination.pageNo+2>=pagination.pageCount }">
                		<li>...</li>
                		<li><a href="javascript:go(${pagination.pageCount-4 })">${pagination.pageCount-4 }</a></li>
                		<li><a href="javascript:go(${pagination.pageCount-3 })">${pagination.pageCount-3 }</a></li>
                		<li><a href="javascript:go(${pagination.pageCount-2 })">${pagination.pageCount-2 }</a></li>
                		<li><a href="javascript:go(${pagination.pageCount-1 })">${pagination.pageCount-1 }</a></li>
                		<li><a href="javascript:go(${pagination.pageCount })">${pagination.pageCount }</a></li>
                	</c:if>
                </c:if>
