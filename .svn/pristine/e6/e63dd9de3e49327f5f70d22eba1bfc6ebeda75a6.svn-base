...
<div class="layui-layout-admin" style="margin: 15px;">
    <form class="layui-form" action="" name="fm" id="fm" method="post" target="BottomInner">
        ...
        <div class="layui-form-pane layui-inline">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input class="layui-input" name="startDate" id="startDate"  placeholder="开始日">
                </div>
                <div class="layui-input-inline">
                    <input class="layui-input" name="endDate" id="endDate" placeholder="截止日">
                </div>
            </div>
        </div>
        <div class="layui-form-item layui-inline">
            <div class="layui-input-inline">
                <input type="text" name="householder" id="householder" lay-verify="required" placeholder="请输入户主名称" autocomplete="off" class="layui-input" maxlength="15">
            </div>
        </div>
        <div class="layui-form-item layui-inline">
            <div class="layui-input-inline">
                <input type="text" name="identityid" id="identityid" lay-verify="required" placeholder="请输入身份证号" autocomplete="off" class="layui-input" maxlength="18">
            </div>
        </div>
        <div class="layui-form-item layui-inline">
            <a href="javascript:;" onclick="checkSubmit();" target="BottomInner" class="layui-btn layui-btn-normal"><i class="layui-icon">&#xe615;</i> 查询</a>
            <a href="javascript:;" onclick="checkSubmitExcel();" target="BottomInner" class="layui-btn layui-btn-normal"><i class="layui-icon">&#xe60a;</i> 导出Excel</a>
        </div>
...
<div class="layui-layout-admin" style="margin: 15px;height:1000px;">
    <span>单位（元）</span>
    <iframe src="${basePath}/order/payments" name="BottomInner" height="100%" width="100%" frameborder="0" scrolling="auto" marginheight="0"></iframe><%--src="${basePath}/order/payments"--%>
</div>
<!------------------------------------------------------------------------------------------------------------------------>
<!------------------------------------------------------------------------------------------------------------------------>
<!------------------------------------------------------------------------------------------------------------------------>
...
<script>
    ...
    function checkSubmit() {
        ...
        fm.action = '${basePath}/order/payments';
        fm.submit();
    }

    function checkSubmitExcel() {
        var fm = document.forms["fm"];
        fm.action = '${basePath}/order/paymentsExcel';
        fm.submit();
    }
</script>
