...
<!------------------------------------------------------------------------------------------------------------------------>
<body>
<div id="up" style="display: none;position: absolute;width: 100%;height: 100%;background: #333;z-index: 99999999999999;opacity: 0.8;text-align: center;color:#e4393c;font-size: 28px;">
    文件上传中...
</div>
<div id="show-div2" style="display:none;">
    <form class="layui-form" action="">
        <table class="layui-table">
            <tr>
                <td style="text-align:center;"><input type="file" name="file" lay-type="file" class="layui-upload-file"></td>
                <td style="text-align:center;"><a href="${basePath }/files/building.xls" class="layui-btn layui-btn-primary">模板下载</a></td>
            </tr>
        </table>
    </form>
</div>
...
<div class="layui-layout-admin" style="margin: 15px;">
    <form class="layui-form" action="${basePath}/init/bings" method="post" id="fm" name="fm" target="BottomInner">
        ...
        <div class="layui-form-item layui-inline layui-form-select">
            <select name="type" lay-verify="">
                ...
                <code:options codeType="povertyType" selected="${message.city}"/>
            </select>
        </div>
        <div class="layui-form-item layui-inline layui-form-select">
        ...
        <div class="layui-form-item layui-inline">
            <div class="layui-input-inline">
                <input type="text" name="householder" lay-verify="required" placeholder="请输入户主名称" autocomplete="off" class="layui-input" maxlength="15">
            </div>
        </div>
        <div class="layui-form-item layui-inline">
            <div class="layui-input-inline">
                <input type="text" name="identityid" lay-verify="required" placeholder="请输入身份证号" autocomplete="off" class="layui-input" maxlength="18">
            </div>
        </div>
        <div class="layui-form-item layui-inline layui-form-select">
        ...
        <div class="layui-form-item layui-inline">
            <div class="layui-input-inline">
                <input type="text" name="account" lay-verify="required" placeholder="请输入卡号" autocomplete="off" class="layui-input" maxlength="20">
            </div>
        </div>
        <div class="layui-form-item layui-inline">
            <a href="javascript:;" onclick="document.getElementById('fm').submit()" target="BottomInner" class="layui-btn layui-btn-normal"><i class="layui-icon">&#xe615;</i> 查询</a>
            <a href="${basePath}/jsp/addbuilding.jsp" target="BottomInner" class="layui-btn layui-btn-normal"><i class="layui-icon">&#xe608;</i> 添加</a>
            <div class="site-demo-button layui-inline" id="LAY_demo" style="margin-bottom: 0;">
                <a href="#" data-method="offset3" data-type="t" class="layui-btn layui-btn-normal" style="background:green;"><i class="layui-icon">&#xe60e;</i>导入</a>
            </div>
        </div>
...
<div class="layui-layout-admin" style="margin: 15px;height:1000px;">
    <span>单位（元）</span>
    <iframe src="${basePath}/init/bings" name="BottomInner" height="100%" width="100%" frameborder="0" scrolling="auto" marginheight="0"></iframe>
</div>
<!------------------------------------------------------------------------------------------------------------------------>
<!------------------------------------------------------------------------------------------------------------------------>
<!------------------------------------------------------------------------------------------------------------------------>
...
<script>
    layui.use('upload', function(){
        layui.upload({
            url: '${basePath}/init/input' //上传接口
            ,success: function(res){ //上传成功后的回调
                document.getElementById("up").style.display = 'none';
                alert(res.res);
               window.location.href = '${basePath}/jsp/manager.jsp';
            }
            ,before:function(input){
                if(!window.confirm("您上传的文件为:"+input.value)){
                    return false;
                }
