...
<div class="yc_container">
 ...
 <div class="yc_location">当前位置：<a href="#">${currentPosition }</a>  &gt; ${ggNews.title }</div>
		<div class="yc_content_inner">
        <section class="showCon">
		<h1>${ggNews.title }</h1>
  <h3>时间：<fmt:formatDate value="${ggNews.publishDate }" pattern="yyyy-MM-dd"/>&nbsp;&nbsp;来源：${ggNews.origin } &nbsp;&nbsp;<font color="#ff0000">字体显示：</font><a onclick="doZoom(18)" style="cursor:hand">大</a> <a onclick="doZoom(16)" style="cursor:hand">中</a> <a onclick="doZoom(12)" style="cursor:hand">小 </a>&nbsp;&nbsp;&nbsp;</h3>
			 <article id="zoom">
  				${ggNews.content }
			 </article>
			<script>
