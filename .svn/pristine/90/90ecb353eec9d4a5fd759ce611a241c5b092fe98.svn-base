...
<!------------------------------------------------------------------------------------------------------------------------>
<!------------------------------------------------------------------------------------------------------------------------>
	<body onload="initPage(${ggNews.isShow},${ggNews.type })">
	<div style="width:90%; margin-left:5%;">
		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
		  <legend>选择新闻类型</legend>
		</fieldset>
				<form class="layui-form" name="fm" action="" method="post">
				<input type="hidden" name="ggNews.seriesNo" value="${ggNews.seriesNo }">
				<div class="layui-form-item layui-inline layui-form-select">
					<select name="ggNews.isShow" id="show" lay-verify="">
				...
				<div class="layui-form-item layui-inline layui-form-select">
					<select name="ggNews.type" id="type" lay-verify="">
				...
				<div class="layui-form-item layui-inline layui-form-select">
					<input name="ggNews.origin" required lay-verify="required" value="${ggNews.origin }" placeholder="请输入新闻来源" autocomplete="off" class="layui-input" type="text">
				</div>
				
				
				<div class="layui-form-item layui-inline layui-form-select">
					<input name="ggNews.title" required lay-verify="required" value="${ggNews.title }" placeholder="请输入标题" autocomplete="off" class="layui-input" type="text">
				</div>
				<input type="hidden" id="imagePath" name="ggNews.imagePath" value="${ggNews.imagePath }">
				<div class="site-demo-upload">
				  <img id="LAY_demo_upload" src="${ggNews.imagePath }">
