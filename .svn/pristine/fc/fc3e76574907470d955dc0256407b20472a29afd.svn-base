...
<div class="layui-layout-admin" style="margin: 15px;">
    <form class="layui-form" action="" id="fm" name="fm" target="BottomInner">
        ...
        <div class="layui-form-item layui-inline">
            <div class="layui-input-inline">
                <input type="text" name="account" lay-verify="required" placeholder="请输入卡号" autocomplete="off" class="layui-input" maxlength="25">
            </div>
        </div>
        <div class="layui-form-pane layui-inline">
            <div class="layui-form-item">
                <label class="layui-form-label">兑付日期</label>
                <div class="layui-input-inline">
                    <input class="layui-input" name="startDate" placeholder="开始日" id="LAY_demorange_s">
                </div>
                <div class="layui-input-inline">
                    <input class="layui-input" name="endDate" placeholder="截止日" id="LAY_demorange_e">
                </div>
            </div>
        </div>
        <div class="layui-form-item layui-inline">
            <a href="javascript:;" onclick="formSubmit();" target="BottomInner" class="layui-btn layui-btn-normal"><i class="layui-icon">&#xe615;</i> 查询</a>
            <a href="javascript:;" onclick="formExcel();" target="BottomInner" class="layui-btn layui-btn-normal"><i class="layui-icon">&#xe60a;</i> 导出Excel</a>
        </div>
...
<div class="layui-layout-admin" style="margin: 15px;height:1000px;">
    <span>单位（元）</span>
    <iframe src="${basePath}/init/cashbuild" name="BottomInner" height="100%" width="100%" frameborder="0" scrolling="auto" marginheight="0"></iframe>
</div>
<!------------------------------------------------------------------------------------------------------------------------>
<!------------------------------------------------------------------------------------------------------------------------>
<!------------------------------------------------------------------------------------------------------------------------>
...
<script>
    function formSubmit(){
        ...
        fm.action = "${basePath}/init/cashbuild";
        fm.submit();
    }
    function formExcel(){
        var fm = document.forms["fm"]
        fm.action = "${basePath}/init/cashbuildExcel";
        debugger;
        fm.submit();
    }
</script>
