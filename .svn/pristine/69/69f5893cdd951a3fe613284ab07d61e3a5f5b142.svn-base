		...
		<div class="layui-layout-admin" style="margin: 15px;">
			...
			<form class="layui-form" name="fm" action="" method="post" enctype="multipart/form-data">
				<div class="layui-form-item layui-inline layui-form-select">
					<input required lay-verify="required" name="menuName" placeholder="请输入菜单名称" autocomplete="off" class="layui-input" type="text">
				</div>
				<div class="layui-form-item layui-inline">
					<a href="javascript:search();" class="layui-btn layui-btn-normal"><i class="layui-icon">&#xe615;</i> 查询</a>
					<a href="${basePath }/adminManage/prepareMenuAdd" class="layui-btn" style="margin-left:20px;" target="resultFrame"><i class="layui-icon">&#xe608;</i> 新增</a>
				</div>
				
			</form>
		</div>
		<div class="layui-layout-admin" style="margin: 15px;height:1000px;">
			<iframe src="${basePath }/adminManage/menuManageResult.jsp" height="100%" name="resultFrame" width="100%" frameborder="0" scrolling="auto" marginheight="0"></iframe>
		</div>
<!------------------------------------------------------------------------------------------------------------------------>
<!------------------------------------------------------------------------------------------------------------------------>
<!------------------------------------------------------------------------------------------------------------------------>
...
<!------------------------------------------------------------------------------------------------------------------------>
		...
		<script>
			...
			function search(){
				fm.action = "${basePath }/adminManage/queryMenu";
