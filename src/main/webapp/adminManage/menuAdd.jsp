		  ...
		  <legend>添加菜单</legend>
				...
				<div class="layui-form-item layui-inline layui-form-select">
					<div class="layui-inline">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="menuCode" id="countya" onblur="calculatePerson()" lay-verify="required" autocomplete="off" class="layui-input">
				      </div>
				    </div>
				</div>
				...
				<div class="layui-form-item layui-inline layui-form-select">
					<div class="layui-inline">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" id="iconInput" data-type="t" name="icon" data-method="iconSelect"  autocomplete="off" class="layui-input">
				      </div>
				    </div>
				</div>
				<div class="layui-form-item layui-inline layui-form-select">
					<div class="layui-inline">
				      ...
				      <div class="layui-input-inline">
						<select name="menuLevel" lay-filter="">
				...
				<div class="layui-form-item layui-inline layui-form-select">
					<div class="layui-inline">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="actionUrl" lay-verify="required" autocomplete="off" class="layui-input">
				      </div>
				    </div>
				</div>
				<div class="layui-form-item layui-inline layui-form-select">
					<div class="layui-inline">
				      ...
				      <div class="layui-input-inline">
						<select name="upperCode" lay-filter="">
						  <option value=" ">无</option>
						  <c:forEach items="${pagination.resultList }" var="menu">
				...
				<div class="layui-form-item layui-inline layui-form-select">
					<div class="layui-inline">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="displayNo" lay-verify="required" autocomplete="off" class="layui-input">
				      </div>
				    </div>
				</div>
...
<!------------------------------------------------------------------------------------------------------------------------>
		...
		<script>
			...
			function submitFm(){
				fm.action = "${basePath }/adminManage/menuAdd";
				fm.submit();
			}
