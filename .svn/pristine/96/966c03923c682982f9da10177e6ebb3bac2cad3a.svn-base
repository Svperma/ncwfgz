...
<div class="layui-layout-admin" style="margin: 15px;">
    <form class="layui-form" action="" nam="fm" id="fm" target="BottomInner" method="post">
        ...
        <%--<div class="layui-form-item layui-inline layui-form-select">
            <select name="city" lay-verify="">
                <option value="">请选择城市</option>
                <code:options codeType="City" selected="${sessionScope.ggUser.city}"/>
            </select>
        </div>
        <div class="layui-form-item layui-inline layui-form-select">
        ...
        <div class="layui-form-item layui-inline">
            <a href="javascript:;" onclick="checkFmSubmit();" target="BottomInner" class="layui-btn layui-btn-normal"><i class="layui-icon">&#xe615;</i> 查询</a>
            <a href="javascript:;" onclick="checkFmExcel1();" target="BottomInner" class="layui-btn layui-btn-normal"><i class="layui-icon">&#xe60a;</i> 导出Excel</a>
        </div>
        <script>
            function checkFmExcel1() {
                var fm = document.forms["fm"];
                fm.action = "${basePath}/init/statisticsExcel";
                fm.submit();
            }
        </script>
    </form>
...
<div class="layui-layout-admin" style="margin: 15px;height:1000px;">
    <iframe src="${basePath}/init/statistics" name="BottomInner" height="100%" width="100%" frameborder="0" scrolling="auto" marginheight="0"></iframe>
</div>
<!------------------------------------------------------------------------------------------------------------------------>
<!------------------------------------------------------------------------------------------------------------------------>
<!------------------------------------------------------------------------------------------------------------------------>
...
<script>
    ...
    function checkFmSubmit() {
        var fm = document.forms["fm"];
        fm.action = "${basePath}/init/statistics";
        fm.submit();
    }
