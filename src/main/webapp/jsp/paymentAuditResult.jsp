...
<div class="layui-layout-admin" style="height:100%;padding:5px;">
    <form class="layui-form" action="${basePath}/order/paymentAuditQueryContinue" id="fm" name="fm" method="post">
            ...
            <tbody>
                <c:forEach items="${sessionScope.pagination.resultList}" var="payment">
                    <tr>
                        ...
                        <td>
                            <a href="javascript:;" onclick="audit('${payment.orderno}');" class="layui-btn layui-btn-warm"><i class="layui-icon">&#xe642;</i>审核</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
...
<script>
	function audit(o){
		parent.location.href = "${basePath}/order/prepareAudit?orderNo="+o;
	}
