...
public class PaginationInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
	       ...
	       MetaObject metaStatementHandler = MetaObject.forObject(statmentHandler,DEFAULT_OBJECTFACTORY,DEFUALT_OBJECTWRAPPERFACTORY,DEFAULT_REFLECTORFACTORY);
	       Object obj = boundSql.getParameterObject();
	       //如果参数对象不是pagination ，则进入下一个拦截器
	       if(!(obj instanceof Pagination)) return invocation.proceed();
	       ...
	       String pageSql = dialect.getPaginationSql(originalSql,page.getPageNo(), page.getPageSize()) ;
     ...
     * @throws SQLException 
     */  
    private int getRowCount(Pagination page, MappedStatement mappedStatement, Connection connection) throws SQLException {  
        int totalRecord = 0;  
