    ...
    <form class="layui-form layui-form-pane" action="" name="f1" id="f1">
        ...
        <div class="layui-form-item layui-inline layui-form-select">
                ...
                <div class="layui-input-inline">
                    ...
                    <%--<input type="text" name="bank" lay-verify="required" id="bank" autocomplete="off" class="layui-input">--%>
                </div>
        </div>
        <div class="layui-form-item layui-inline">
            <label class="layui-form-label">账号</label>
            <div class="layui-input-inline">
                <input type="text" name="username" lay-verify="required" placeholder="请输入账号" id="account" autocomplete="off" class="layui-input" onblur="checkNumberValue(this)" maxlength="20" onclick="fuoux(this)">
            </div>
        </div>
        <div class="layui-form-item layui-inline layui-form-select">
...
//                        buildingmst = data;
                        ...
                        var bankOp = document.getElementById("bank");
                        for(var x=0; x<bankOp.length; x++){
                            if(bankOp[x].innerHTML == data.bank){
                                bankOp[x].selected = true
                            }
                        }

//                        document.getElementById("bank").value = data.bank;
                        var accountValue = data.account == '' ? '无' : data.account;
                ...
                layer.open({
                    ...
                    ,yes: function(){
                        ...
                        var subbank = document.getElementById("bank").value;
                        var subaccount = document.getElementById("account").value;
                        console.log(subbank + " : " + subaccount)
                        window.location.href = '${basePath}/init/updateBank?id='+objid+'&bank='+subbank+'&account='+subaccount;
                        layer.closeAll();
                    }
                });
            }
